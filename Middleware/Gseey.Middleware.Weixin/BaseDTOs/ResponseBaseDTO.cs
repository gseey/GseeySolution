...
namespace Gseey.Middleware.Weixin.BaseDTOs
{
    public class ResponseBaseDTO
    {
        ...
        /// 企业号错误消息
        /// </summary>
        public string WorkErrorMsg
        {
            get
            {
                return ((WorkReturnCode)errcode).ToString();
            }
        }
        ...
        /// 公众号错误消息
        /// </summary>
        public string MpErrorMsg
        {
            get
            {
                return ((MpReturnCode)errcode).ToString();
            }
        }
